...
?>
<div class="container">
 	<h1 align=center>Admin Login for NewLife Hospital</h1>
  <?php

              echo '<a class="nav-link" href="trigger.php"><h3 style="color:black">Patient Information</h3></a>
            </li>';
            echo '<a class="nav-link" href="procedure.php"><h3 style="color:black">Doctor Information</h3></a>
          </li>';
